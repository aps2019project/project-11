...
public class BattleFieldController extends Thread
{
            ...
            for (int column = 0; column < 9; column++)
            {
                ...
                battleFieldCells[row][column].getCellPane().setOnMouseClicked(new EventHandler<MouseEvent>()
                {
                    ...
                    public void handle(MouseEvent event)
                    {
                        ...
                        {
                            System.out.println(battleFieldCells[finalRow][finalColumn].getCard().getCardID() + " is selected");
    ...
    {
        final Animation animation = new SpriteAnimation(imageView, Duration.millis(5000), 30, 10, 0, 0, 80, 80);
