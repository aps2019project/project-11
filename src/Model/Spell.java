...
public class Spell extends Card
{
    ...
    public static void setSpells()
    {
        ...
        spellOne.getSpellEffect().addSpellChange( new SpellChange(0 , false , true  , 0 , 0 , 0 , false , true , false , false ,false , false,false,false,false));
        ...
        spellTwo.getSpellEffect().addSpellChange(new SpellChange(1,true,false, 0,0,0,false,false,false,false,false,false,false,false,false));
        ...
        spellThree.getSpellEffect().addSpellChange(new SpellChange(1,true,false,2,0,0,false,false,false,false,false,false,false,false,false));
        ...
        spellFour.getSpellEffect().addSpellChange(new SpellChange(1,false,false,0,-4,0,false,false,false,false,false,false,false,false,false));
        ...
        spellFive.getSpellEffect().addSpellChange(new SpellChange(1,true,false,4,0,0,false, false,false,false,false,false,false,false,false));
        ...
        spellSix.getSpellEffect().addSpellChange(new SpellChange(2,false,false,0,0,0,false,false,false,false,false,false,true,false,false));
        spellSix.getSpellEffect().addTarget(new Target(0,0,false,false,0,0,0 ,  0 , 0  ,  0,null,false,false,false));

        Spell spellSeven = new Spell("lightingBolt",1250,2,"impactToOpponent");
        spellSeven.getSpellEffect().addSpellChange(new SpellChange(1,false,false,0,-8,0,false,false,false,false,false,false,false,false,false));
        ...
        spellEigth.getSpellEffect().addSpellChange(new SpellChange(1,false,false,0,0,0,false,false,false,false,true,false,false,false,false));
        spellEigth.getSpellEffect().addTarget(new Target(0,0,false,false,0,0,  0 , 0  , 0  , 0  ,null,false,false,false));

        Spell spellNine = new Spell("madness",650,0,"addingAPButDisarm");
        spellNine.getSpellEffect().addSpellChange(new SpellChange(3,true,false,4,0,0,false,false,false,false,false,false,false,false,false));
        ...
        spellTen.getSpellEffect().addSpellChange(new SpellChange(1,false,false,0,0,0,false,true,false,false,false,false,false,false,false));
        ...
        spellEleven.getSpellEffect().addSpellChange(new SpellChange(4,false,false,0,0,0,false,false,false,false,true,false,false,false,false));
        ...
        spellSixteen.getSpellEffect().addSpellChange(new SpellChange(1,false,false,0,-6,0,false,false,false,false,false,false,false,false,false));
        ...
        spellSeventeen.getSpellEffect().addSpellChange(new SpellChange(1,false,false,-4,0,0,false,false,false,false,false,false,false,false,false));
        ...
        spellEighteen.getSpellEffect().addSpellChange(new SpellChange(1,true,false,8,0,0,false,false,false,false,false,false,false,false,false));
        spellEighteen.getSpellEffect().addSpellChange(new SpellChange(1,false,false,0,-6,0,false,false,false,false,false,false,false,false,false));
        ...
        spellNineteen.getSpellEffect().addSpellChange(new SpellChange(1,false,false,0,0,0,false,false,false,false,false,false,false,false,true));
        ...
        spellTwenty.getSpellEffect().addSpellChange(new SpellChange(2,false,false,0,0,0,true,false,false,false,false,false,false,false,false));
