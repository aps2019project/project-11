...
public class Spell extends Card
{
    ...
    public static void setSpells()
    {
        ...
        spellOne.getSpellEffect().addTarget(new Target(0,0,false, false, 1 , 0, false, 1,1,  null,false,false,false));
        ...
        spellTwo.getSpellEffect().addTarget(new Target(0, 0, false, false,0 , 0, false, 2,2,null,false,true,true));
        ...
        spellThree.getSpellEffect().addTarget(new Target(0,0,false,false,0,1, false, 1, 1,null,false,false,false));
        ...
        spellFour.getSpellEffect().addTarget(new Target(0,0,false,false,1,0,false, 1, 1,null,false,false,false));
        ...
        spellFive.getSpellEffect().addTarget(new Target(0,0,true,false,0,0,false, 1, 1,null,false,false,false));
        ...
        spellSix.getSpellEffect().addTarget(new Target(0,0,false,false,0,0,true, 2, 2,null,false,false,false));
        ...
        spellSeven.getSpellEffect().addTarget(new Target(0,0,false,true,0,0,false, 1, 1,null,false,false,false));
        ...
        spellEight.getSpellEffect().addTarget(new Target(0,0,false,false,0,0,true, 3, 3 ,null,false,false,false));
        ...
        spellNine.getSpellEffect().addTarget(new Target(0,0,false,false,0,1,false, 1, 1,null,false,false,false));
        ...
        spellTen.getSpellEffect().addTarget(new Target(0,0,false,false,0,0,false, 9, 5,null,false,true,false));
        ...
        spellEleven.getSpellEffect().addTarget(new Target(0,0,false,false,0,0,false, 9, 5,null,false,true,false));
        ...
        spellTwelve.getSpellEffect().addTarget(new Target(1,1,false,false,0,0,false, 1, 1,null,false,false,false));
        ...
        spellThirteen.getSpellEffect().addTarget(new Target(0,0,false,false,0,1,false, 1, 1,null,false,false,false));
        ...
        spellFourteen.getSpellEffect().addTarget(new Target(0,0,false,false,0,1,false , 1, 1,null,false,false,false));
        ...
        spellFifteen.getSpellEffect().addTarget(new Target(0,0,false,false,0,0,false, 9, 5,null,false,false,true));
        ...
        spellSixteen.getSpellEffect().addTarget(new Target(0,0,false,false,0,0,false, 1, 5,null,false,true,false));
        ...
        spellSeventeen.getSpellEffect().addTarget(new Target(0,1,false,false,0,0,false, 1, 1,null,false,false,false));
        ...
        spellEighteen.getSpellEffect().addTarget(new Target(1,0,false,false,0,0,false, 1, 1,null,false,false,false));
        ...
        spellNineteen.getSpellEffect().addTarget(new Target(0,1,false,false,0,0,false, 3, 3,null,false,false,false));
        ...
        spellTwenty.getSpellEffect().addTarget(new Target(0,1,false,false,1,0,false, 1, 1,null,false,false,false));
    }
