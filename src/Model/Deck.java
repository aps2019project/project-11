            ...
            switch (i)
            {
                case 1:
                    ...
                    deck1.addNonHeroCardToDeck((Card) Card.findCard("totalDisarm").clone(), true).addNonHeroCardToDeck((Card) Card.findCard("lightingBolt").clone(), true).addNonHeroCardToDeck((Card) Card.findCard("allDisarm").clone(), true).addNonHeroCardToDeck((Card) Card.findCard("allPoison").clone(), true).addNonHeroCardToDeck((Card) Card.findCard("dispel").clone(), true).addNonHeroCardToDeck((Card) Card.findCard("sacrifice").clone(), true).
                            addNonHeroCardToDeck((Card) Card.findCard("shock").clone(), true)./*todo*//*todo*/addNonHeroCardToDeck((Card) Card.findCard("Gorzdar Torani").clone(), true).addNonHeroCardToDeck((Card) Card.findCard("Gorzdar Torani").clone(), true).addNonHeroCardToDeck((Card) Card.findCard("Dive siah").clone(), true).addNonHeroCardToDeck((Card) Card.findCard("Ghoul TakCheshm").clone(), true).addNonHeroCardToDeck((Card) Card.findCard("Mar Sammi").clone(), true).
                            addNonHeroCardToDeck((Card) Card.findCard("Mar Ghoul Peykar").clone(), true)./*todo*/addNonHeroCardToDeck((Card) Card.findCard("JadoGar Azam").clone(), true).addNonHeroCardToDeck((Card) Card.findCard("Siavash").clone(), true).addNonHeroCardToDeck((Card) Card.findCard("Nane Sarma").clone(), true).addNonHeroCardToDeck((Card) Card.findCard("Arzhang Div").clone(), true);
                ...
                case 2:
                    ...
                    deck2.addNonHeroCardToDeck((Card) Card.findCard("areaDispel").clone(), true).addNonHeroCardToDeck((Card) Card.findCard("empower").clone(), true).addNonHeroCardToDeck(Card.findCard("godStrength"), true).addNonHeroCardToDeck((Card) Card.findCard("madness").clone(), true).addNonHeroCardToDeck((Card) Card.findCard("poisonLake").clone(), true).addNonHeroCardToDeck((Card) Card.findCard("healthWithProfit").clone(), true).addNonHeroCardToDeck((Card) Card.findCard("kingGuard").clone(), true).
                            /*todo*//*todo*//*todo*//*todo*/addNonHeroCardToDeck((Card) Card.findCard("Shahzade Torani").clone(), true).addNonHeroCardToDeck((Card) Card.findCard("Oghab").clone(), true).addNonHeroCardToDeck((Card) Card.findCard("Oghab").clone(), true).addNonHeroCardToDeck((Card) Card.findCard("Ezhdehaye Atash Andaz").clone(), true).addNonHeroCardToDeck((Card) Card.findCard("Palang").clone(), true).addNonHeroCardToDeck((Card) Card.findCard("Genn").clone(), true).
