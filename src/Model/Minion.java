...
public class Minion extends NonSpellCards
{
    ...
    public static void setMinions()
    {
        ...
        Minion minion24 = new Minion("Gorg" ,400 , 3 ,6 , 1 , ImpactType.melee , 0 ,null/*todo*/ ,  TimeToActivateSpecialPower.onAttack);
        Minion minion25 = new Minion("JadoGar" ,550 , 4 ,5 , 4 , ImpactType.ranged , 3 ,null/*todo*/ ,  TimeToActivateSpecialPower.passive);
        Minion minion26 = new Minion("JadoGar Azam" ,550 , 6 ,6 , 6 , ImpactType.ranged , 5 ,null/*todo*/ ,  TimeToActivateSpecialPower.passive);
        Minion minion27 = new Minion("Genn" ,500 , 6 ,10 , 4 , ImpactType.ranged , 4 ,null/*todo*/ ,  TimeToActivateSpecialPower.onTurn);
        Minion minion28 = new Minion("Goraz Vahshi" ,500 , 6 ,10 , 14 , ImpactType.melee , 0 ,null/*todo*/ ,  TimeToActivateSpecialPower.onDefend);
        Minion minion29 = new Minion("Piran" ,400 , 8 ,20 , 12 , ImpactType.melee , 0 ,null/*todo*/ ,  TimeToActivateSpecialPower.onDefend);
        Minion minion30 = new Minion("Giv" ,450 , 4 ,5 , 7 , ImpactType.ranged , 5 ,null/*todo*/ ,  TimeToActivateSpecialPower.onDefend);
        Minion minion31 = new Minion("Bahman" ,450 , 8 ,16 , 9 , ImpactType.melee , 0 ,null/*todo*/ ,  TimeToActivateSpecialPower.onSpawn);
        Minion minion32 = new Minion("AshkBos" ,400 , 7 ,14 , 8 , ImpactType.melee , 0 ,null/*todo*/ ,  TimeToActivateSpecialPower.onDefend);
        ...
        Minion minion35 = new Minion("Ghoul Dosar" ,550 , 4 ,10 , 4 , ImpactType.melee , 0 ,null/*todo*/,  TimeToActivateSpecialPower.onAttack);
        Minion minion36 = new Minion("Nane Sarma" ,500 , 3 ,3 , 4 , ImpactType.ranged , 5 ,null/*todo*/,  TimeToActivateSpecialPower.onSpawn );
        Minion minion37 = new Minion("Folad Zereh" ,650 , 3 ,1 , 1 , ImpactType.melee, 0 ,null/*todo*/,  TimeToActivateSpecialPower.passive );
        Minion minion38 = new Minion("Siavash" ,350 , 4 ,8 , 5 , ImpactType.melee, 0 ,null/*todo*/,  TimeToActivateSpecialPower.onDeath);
        Minion minion39 = new Minion("Shah Ghoul" ,600 , 5 ,10 , 4 , ImpactType.melee, 0 ,null/*todo*/,  TimeToActivateSpecialPower.combo);
        Minion minion40 = new Minion("Arzhang Div" ,600 , 3 ,6 , 6 , ImpactType.melee, 0 ,null/*todo*/,  TimeToActivateSpecialPower.combo);
    }
