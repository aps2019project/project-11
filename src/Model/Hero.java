...
public class Hero extends NonSpellCard
{
    ...
    public static void setHeroes()
    {
        ...
        specialPowerHero1.getSpellEffect().addTarget(new Target(0, 0, true, false, 0, 0, false, 1, 1, null, false, false, false));
        ...
        specialPowerHero2.getSpellEffect().addTarget(new Target(0, 0, false, false, 0, 0, false, 9, 5, null, false, true, false));
        ...
        specialPowerHero3.getSpellEffect().addTarget(new Target(0, 0, false, false, 1, 0, false, 9, 5, null, false, false, false));
        ...
        specialPowerHero4.getSpellEffect().addTarget(new Target(0, 0, false, false, 1, 0, false, 9, 5, null, false, false, false));
        ...
        specialPowerHero5.getSpellEffect().addTarget(new Target(0, 0, false, false, 1, 0, false, 1, 1, null, false, false, false));
        ...
        specialPowerHero6.getSpellEffect().addTarget(new Target(0, 0, false, false, 0, 0, true, 1, 1, null, false, false, false));
        ...
        specialPowerHero7.getSpellEffect().addTarget(new Target(0, 0, false, false, 0, 0, false, 9, 1, null, false, true, false));
        ...
        specialPowerHero8.getSpellEffect().addTarget(new Target(0, 0, false, false, 1, 0, false, 9, 5, null, false, false, false));
        ...
        specialPowerHero9.getSpellEffect().addTarget(new Target(0, 0, true, false, 0, 0, false, 1, 1, null, false, false, false));
        ...
        specialPowerHero10.getSpellEffect().addTarget(new Target(0, 0, false, false, 0, 0, false, 0, 0, null, false, false, false));
