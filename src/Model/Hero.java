...
public class Hero extends NonSpellCard
{
    ...
    public Hero(String name, int price, int HP, int AP, int Mp, int coolDown, SpecialPower specialPower, ImpactType impactType, int rangeOfAttack)
    {
        setCardName(name);
        setPrice(price);
        setDefaultHP(HP);
    ...
    public static void setHeroes()
    {
        ...
        new Hero("SevenHeadedDragon", 8000, 50, 4, 0, 1, specialPowerHero3, ImpactType.melee, 0);
        ...
        new Hero("Rakhsh", 8000, 50, 4, 1, 2, specialPowerHero4, ImpactType.melee, 0);
        ...
        new Hero("Zahak", 10000, 50, 2, 0, 0, specialPowerHero5, ImpactType.melee, 0);
        ...
        new Hero("Kaveh", 8000, 50, 4, 1, 3, specialPowerHero6, ImpactType.melee, 0);
        ...
        new Hero("Arash", 10000, 30, 2, 2, 2, specialPowerHero7, ImpactType.ranged, 6);
        ...
        new Hero("Afsaneh", 11000, 40, 3, 1, 2, specialPowerHero8, ImpactType.ranged, 3);
        ...
        new Hero("Esfandiar", 12000, 35, 3, 0, 0, specialPowerHero9, ImpactType.hybrid, 3);
